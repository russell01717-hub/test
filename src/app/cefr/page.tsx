      ...
      <section className="flex-1 py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <Badge className="mb-4 gradient-bg text-white">CEFR</Badge>
            <h1 className="text-3xl md:text-5xl font-bold mb-4">CEFR bo'yicha ko'nikmalar</h1>
            <p className="text-muted-foreground text-lg">Davlat standarti bo'yicha arab tili darajangizni aniqlang</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {skills.map((s, i) => (
              <Link key={s.id} href={`/cefr/${s.id}`}>
                <Card className="group cursor-pointer hover:shadow-xl transition-all duration-300 h-full animate-fade-in" style={{ animationDelay: `${i * 0.1}s` }}>
                  <CardHeader>
                    <div className="w-10 h-10 rounded-lg gradient-bg flex items-center justify-center mb-2">
