      ...
      <Card className="w-full max-w-md animate-scale-in">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={loading}>{loading ? "Kirish..." : "Kirish"}</Button>
          </form>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Hisobingiz yo'qmi? <Link href="/auth/register" className="text-primary hover:underline">Ro'yxatdan o'tish</Link>
          </p>
        </CardContent>
      </Card>
    </div>
